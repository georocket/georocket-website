  ...
  <div class="d-lg-flex try-cards">
    <div class="card text-center mb-3 py-2 mr-lg-3">
      <div class="card-block">
        ...
        <a href="https://github.com/georocket/georocket/releases/download/v1.2.0/georocket-server-1.2.0.zip" class="btn btn-primary btn-icon-separate mb-4"><i class="mdi mdi-download" aria-hidden="true"></i> Download server</a>
        <a href="https://github.com/georocket/georocket/releases/download/v1.2.0/georocket-cli-1.2.0.zip" class="btn btn-primary btn-icon-separate mb-4"><i class="mdi mdi-download" aria-hidden="true"></i> Download CLI</a>
      </div>
    </div>
